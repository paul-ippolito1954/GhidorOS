...
(function (TSOS) {
    class Cpu {
        constructor(PC = 0, Acc = 0, IR = "00", Xreg = 0, Yreg = 0, Zflag = 0, isExecuting = false) {
            this.PC = PC;
            this.Acc = Acc;
            this.IR = IR;
            this.Xreg = Xreg;
        ...
        decode(opCode) {
            ...
            switch (opCode) {
                ...
                case ("FF"):
                    ...
                    if (this.Xreg == 1) {
                        this.PC += 1;
                        _KernelInterruptQueue.enqueue(new TSOS.Interrupt(OUTPUT_IRQ, String(this.Yreg)));
                        ...
                        this.PC += 1;
                        _KernelInterruptQueue.enqueue(new TSOS.Interrupt(OUTPUT_IRQ, yString));
                ...
                default:
                    ...
                    _KernelInterruptQueue.enqueue(new TSOS.Interrupt(OPCODE_ERROR_IRQ, msg));
            }
            cpuCycles += 1;
